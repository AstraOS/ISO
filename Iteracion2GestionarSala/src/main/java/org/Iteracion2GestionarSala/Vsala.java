...
public class Vsala {
    ...
    private void initialize() {
        ...
        frmGestinDeSala.getContentPane().
        add(lblListaDeTurnos, gbc_lblListaDeTurnos);

        listaTurnos = new JList<Turno>();
        listaTurnos.addListSelectionListener(new
                ListaTurnosListSelectionListener());
        ...
        frmGestinDeSala.getContentPane().
        add(lblEstadoActual, gbc_lblEstadoActual);
        ...
        JLabel lblRecordatorioParaHacer = new JLabel(
                "Recordatorio: Para hacer la "
                + "reserva de una mesa, debe estar libre");
        GridBagConstraints gbc_lblRecordatorioParaHacer =
        ...
        frmGestinDeSala.getContentPane().
        add(lblRecordatorioParaHacer, gbc_lblRecordatorioParaHacer);
        ...
        frmGestinDeSala.getContentPane().
        add(btnReservarMesa, gbc_btnReservarMesa);
    ...
    private class BtnReservarTurnoActionListener implements ActionListener {
        public void actionPerformed(final ActionEvent e) {
            list.getSelectedValue().getTurnos().
            get((listaTurnos.getSelectedValue().getId())).setEstado("Ocupado");
            txtEstado.setText(
                    list.getSelectedValue().getTurnos().
                    get(listaTurnos.getSelectedValue().getId()).getEstado());
            btnReservarMesa.setEnabled(false);
    ...
    private class ListListSelectionListener implements ListSelectionListener {
        public void valueChanged(final ListSelectionEvent e) {
            ...
            for (int i = 0; i < list.getSelectedValue()
                    .getTurnos().size(); i++) {
     ...
     *
     */
    private class ListaTurnosListSelectionListener

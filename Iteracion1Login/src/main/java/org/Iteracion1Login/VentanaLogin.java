...
public class VentanaLogin {
    ...
    private void initialize() {
        ...
        frmLogin.setIconImage(
                Toolkit.getDefaultToolkit().getImage(VentanaLogin.
                        class.getResource("/iconos/baker.png")));
        ...
        lblLblicono.setIcon(new ImageIcon(VentanaLogin.class.
                getResource("/iconos/Cocinero.png")));
